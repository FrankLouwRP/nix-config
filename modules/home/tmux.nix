...

{
  programs.tmux = {
    ...
    extraConfig = ''
      ...
      ${lib.optionalString pkgs.stdenv.isLinux ''bind-key -n MouseDown3Pane run "tmux set-buffer \"''$(/mnt/c/Windows/System32/WindowsPowerShell/v1.0/powershell.exe -c Get-Clipboard | tr -d '\r')\"; tmux paste-buffer"''}
